...
async def archive_msg(msg: Message):
    buttons = [[InlineKeyboardButton("حذف فایل🗑", callback_data='delete-file')]]
    ...
    if msg.chat.username:
        buttons[0].append(InlineKeyboardButton("🔆کاربر", url=f'https://t.me/{msg.chat.username}'))
    else:
        buttons[0].append(InlineKeyboardButton("🔆کاربر", callback_data=f'user|{msg.chat.id}'))
